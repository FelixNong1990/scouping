...
if(isset($_POST['doRegister']))
{
    ...
    if (get_option('wp_aff_use_recaptcha'))
    {
        ...
        if (!$resp->is_valid) {
        	$recaptcha_error = AFF_IMAGE_VERIFICATION_FAILED;//$resp->error;
	...
	$aemail = $wpdb->escape($_POST['aemail']);
	$user_name = $wpdb->escape($_POST['user_name']);
	$userid = $wpdb->escape($_POST['user_name']);
    ...
    if($result){
        ...
        global $wpdb;
        $affiliates_table_name = WP_AFF_AFFILIATES_TABLE;
        $updatedb = "INSERT INTO $affiliates_table_name (refid,pass,company,firstname,lastname,website,email,payableto,street,town,state,postcode,country,phone,date,paypalemail,commissionlevel,referrer,tax_id,account_details,sec_tier_commissionlevel) VALUES ('".$_POST['user_name']."', '".$password."', '".$_POST['acompany']."', '".$_POST['afirstname']."', '".$_POST['alastname']."', '".$_POST['awebsite']."', '".$_POST['aemail']."', '".$_POST['apayable']."', '".$_POST['astreet']."', '".$_POST['atown']."', '".$_POST['astate']."', '".$_POST['apostcode']."', '".$_POST['acountry']."', '".$_POST['aphone']."', '$date','".$_POST['paypal_email']."','".$commission_level."','".$referrer."', '".$_POST['tax_id']."','$account_details','$sec_tier_commissionlevel')";
    ...
    <!-- Start Registration Form -->
      <form action="register.php" method="post" name="regForm" id="regForm" >
        <table width="95%" border="0" cellpadding="3" cellspacing="3" class="forms">
          ...
          <tr> 
            <td><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#000000"><?php echo AFF_TAX_ID; ?>:</font></b></td>
            <td><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#000000"> 
