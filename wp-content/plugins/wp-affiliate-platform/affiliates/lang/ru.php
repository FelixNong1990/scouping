...
define(AFF_DISPLAY_DATA_BUTTON_TEXT, 'Показать дату'); 
...
// Members only page
define(AFF_WELCOME, 'Добро пожаловать');
...
define(AFF_COMMISSION_LEVEL, 'Процент комиссии');
...
define(AFF_C_CLICKS, 'Клики с вашего сайта');
define(AFF_C_SHOWING_20, 'Последние 20 кликов');
...
// Sales page
define(AFF_S_SALES, 'Продажи ваших рефералов');  
define(AFF_S_SHOWING_20, 'Последние 20 продаж');  
define(AFF_S_NO_SALES, 'Ваши рефералы пока ничего не продали');  
...
define(AFF_P_LAST_20_PAYMENTS, '20 последних выплат');

// Banners Page
define(AFF_B_BANNER_PAGE_TITLE, 'Партнерские баннеры и ссылки');  
...
define(AFF_B_BANNERS, 'Вы можете использовать эти ссылки');      
...
define(AFF_NAV_EDIT_PROFILE, 'Редактировать профайл');  
define(AFF_NAV_REFERRALS, 'Рефералы');  
define(AFF_NAV_SALES, 'Продажи');  
define(AFF_NAV_PAYMENT_HISTORY, 'История оплат');  
define(AFF_NAV_BANNERS, 'Баннера');  
