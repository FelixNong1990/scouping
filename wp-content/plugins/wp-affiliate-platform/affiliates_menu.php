...
function edit_affiliates_menu()
{
	...
	if (isset($_POST['Submit']))
	{
		...
		$validation_msg = "";
		if(!isset($_POST['editedaffiliate'])){$_POST['editedaffiliate']="";}
		...
		$account_status = $wpdb->escape($_POST['account_status']);
		...
		if(!$form_fields_validated){
			...
			if ($post_editedaffiliate=='')
			{
				...
				if (!empty($post_refid))
				{
					$updatedb = "INSERT INTO $affiliates_table_name (refid,pass,company,title,firstname,lastname,website,email,payableto,street,town,state,postcode,country,phone,fax,date,paypalemail,commissionlevel,referrer,tax_id,account_details,sec_tier_commissionlevel,account_status) VALUES ('$post_refid','$post_pass','$post_company','$post_title','$post_firstname','$post_lastname','$post_website','$post_email','$post_payableto','$post_street','$post_town','$post_state','$post_postcode','$post_country','$post_phone','$post_fax','$post_date','$post_paypalemail','$post_commissionlevel','$post_referrer','$post_tax_id','$post_account_details','$post_sec_tier_commissionlevel','$account_status')";
					$results = $wpdb->query($updatedb);
...
<td><input name="refid" type="text" id="refid" value="<?php if(isset($editingaff->refid)){echo $editingaff->refid;} ?>" size="20" <?php echo $read_only_value; ?> /><br/><?php _e('Affiliate ID of the Affiliate (permitted characters are letters, numbers and underscore)', 'wp_affiliate'); ?></td>
</tr>

<tr valign="top">
<th scope="row"><?php _e('Login Password', 'wp_affiliate'); ?></th>
<td><input name="pass" type="password" id="pass" value="" size="20" />
<input name="encrypted-pass" type="hidden" value="<?php if(isset($editingaff->pass)){echo $editingaff->pass;} ?>" size="20" />
<br/>
<?php 
if (isset($_GET['editaff'])){
...
<td><input name="title" type="text" id="title" value="<?php if(isset($editingaff->title)){echo $editingaff->title;} ?>" size="10" /><br/><?php _e('Title of the Affiliate', 'wp_affiliate'); ?></td>
</tr>

<tr valign="top">
<th scope="row"><?php _e('First Name', 'wp_affiliate'); ?></th>
<td><input name="firstname" type="text" id="firstname" value="<?php if(isset($editingaff->firstname)){echo $editingaff->firstname;} ?>" size="40" /><br/><?php _e('First Name of the Affiliate', 'wp_affiliate'); ?></td>
</tr>

<tr valign="top">
<th scope="row"><?php _e('Last Name', 'wp_affiliate'); ?></th>
<td><input name="lastname" type="text" id="lastname" value="<?php if(isset($editingaff->lastname)){echo $editingaff->lastname;} ?>" size="40" /><br/><?php _e('Last Name of the Affiliate', 'wp_affiliate'); ?></td>
</tr>

<tr valign="top">
<th scope="row"><?php _e('Company', 'wp_affiliate'); ?></th>
<td><input name="company" type="text" id="company" value="<?php if(isset($editingaff->company)){echo $editingaff->company;} ?>" size="40" /><br/></td>
</tr>

<tr valign="top">
<th scope="row"><?php _e('Website', 'wp_affiliate'); ?></th>
<td><input name="website" type="text" id="website" value="<?php if(isset($editingaff->website)){echo $editingaff->website;} ?>" size="40" /><br/><?php _e('Website Address of the Affiliate', 'wp_affiliate'); ?></td>
</tr>

<tr valign="top">
<th scope="row"><?php _e('Email Address', 'wp_affiliate'); ?></th>
<td><input name="email" type="text" id="email" value="<?php if(isset($editingaff->email)){echo $editingaff->email;} ?>" size="40" /><br/><?php _e('Email Address of the Affiliate', 'wp_affiliate'); ?></td>
</tr>

<tr valign="top">
<th scope="row"><?php _e('Payable To', 'wp_affiliate'); ?></th>
<td><input name="payableto" type="text" id="payableto" value="<?php if(isset($editingaff->payableto)){echo $editingaff->payableto;} ?>" size="40" /><br/><?php _e('This can be used when paying the affiliate using a Cheque/Check', 'wp_affiliate'); ?></td>
</tr>

<tr valign="top">
<th scope="row"><?php _e('Street Address', 'wp_affiliate'); ?></th>
<td><input name="street" type="text" id="street" value="<?php if(isset($editingaff->street)){echo $editingaff->street;} ?>" size="40" /><br/><?php _e('Street Address of the Affiliate', 'wp_affiliate'); ?></td>
</tr>

<tr valign="top">
<th scope="row"><?php _e('City', 'wp_affiliate'); ?></th>
<td><input name="town" type="text" id="town" value="<?php if(isset($editingaff->town)){echo $editingaff->town;} ?>" size="20" /><br/></td>
</tr>

<tr valign="top">
<th scope="row"><?php _e('State', 'wp_affiliate'); ?></th>
<td><input name="state" type="text" id="state" value="<?php if(isset($editingaff->state)){echo $editingaff->state;} ?>" size="20" /><br/></td>
</tr>

<tr valign="top">
<th scope="row"><?php _e('Post Code', 'wp_affiliate'); ?></th>
<td><input name="postcode" type="text" id="postcode" value="<?php if(isset($editingaff->postcode)){echo $editingaff->postcode;} ?>" size="10" /><br/></td>
</tr>

<tr valign="top">
<th scope="row"><?php _e('Country', 'wp_affiliate'); ?></th>
<td><input name="country" type="text" id="country" value="<?php if(isset($editingaff->country)){echo $editingaff->country;} ?>" size="20" /><br/></td>
</tr>

<tr valign="top">
<th scope="row"><?php _e('Phone Number', 'wp_affiliate'); ?></th>
<td><input name="phone" type="text" id="phone" value="<?php if(isset($editingaff->phone)){echo $editingaff->phone;} ?>" size="20" /><br/></td>
</tr>

<tr valign="top">
<th scope="row"><?php _e('Fax Number', 'wp_affiliate'); ?></th>
<td><input name="fax" type="text" id="fax" value="<?php if(isset($editingaff->fax)){echo $editingaff->fax;} ?>" size="20" /><br/></td>
</tr>

<tr valign="top">
<th scope="row"><?php _e('Date Joined (yyyy-mm-dd)', 'wp_affiliate'); ?></th>
<td><input name="date" type="text" id="date" value="<?php if(isset($editingaff->date)){echo $editingaff->date;} ?>" size="20" /><br/><?php _e('This value must be entered in the format yyyy-mm-dd. Leave empty to use todays date.', 'wp_affiliate'); ?></td>
</tr>

<tr valign="top">
<th scope="row"><?php _e('PayPal Email Address', 'wp_affiliate'); ?></th>
<td><input name="paypalemail" type="text" id="paypalemail" value="<?php if(isset($editingaff->paypalemail)){echo $editingaff->paypalemail;} ?>" size="40" /><br/><?php _e('This address is used to pay the Affiliate through PayPal', 'wp_affiliate'); ?></td>
</tr>

<tr valign="top">
<th scope="row"><?php _e('Bank Account Details', 'wp_affiliate'); ?></th>
<td><textarea name="account_details" cols="50" rows="3"><?php if(isset($editingaff->account_details)){echo $editingaff->account_details;} ?></textarea>
...
<td><input name="tax_id" type="text" id="tax_id" value="<?php if(isset($editingaff->tax_id)){echo $editingaff->tax_id;} ?>" size="40" /><br/><?php _e('Tax ID of this affiliate if applicable', 'wp_affiliate'); ?></td>
</tr>

<tr valign="top">
<th scope="row"><?php _e('Commission Level (% or $)', 'wp_affiliate'); ?></th>
<td><input name="commissionlevel" type="text" id="commissionlevel" value="<?php if(isset($editingaff->commissionlevel)){echo $editingaff->commissionlevel;} ?>" size="4" /><br/><?php _e('Only enter the number (do not use "%" or "$" sign).', 'wp_affiliate'); ?></td>
</tr>

<tr valign="top">
<th scope="row"><?php _e('2nd Tier Commission Level (% or $)', 'wp_affiliate'); ?></th>
<td><input name="sec_tier_commissionlevel" type="text" id="sec_tier_commissionlevel" value="<?php if(isset($editingaff->sec_tier_commissionlevel)){echo $editingaff->sec_tier_commissionlevel;} ?>" size="4" /><br/><?php _e('Only enter the number (do not use "%" or "$" sign). The value you specify here will override the default 2nd tier commission level for this affiliate.', 'wp_affiliate'); ?></td>
</tr>

<tr valign="top">
<th scope="row"><?php _e('Referrer ID', 'wp_affiliate'); ?></th>
<td><input name="referrer" type="text" id="referrer" value="<?php if(isset($editingaff->referrer)){echo $editingaff->referrer;} ?>" size="20" /><br/><?php _e('Affiliate ID of the affiliate who referred this affiliate (This value is used when tier affiliate model is used)', 'wp_affiliate'); ?></td>
</tr>
