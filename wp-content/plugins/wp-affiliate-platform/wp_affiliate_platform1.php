...
{
	$output = "";
	if(!isset($_POST['wp_aff_affiliate_id'])){$_POST['wp_aff_affiliate_id']="";}	
...
function wp_aff_handle_plugins_loaded_hook()
{
	if(is_admin()){//Check if DB needs to be updated
    	if (get_option('wp_affiliates_version') != WP_AFFILIATE_PLATFORM_DB_VERSION) {wp_affiliate_platform_run_activation();}
	}	
}
