			...
			<div class="blog">
				...
				<div class="text-box">
					...
					<table class="couponList">
						<thead>
							<tr>
								<th class="col1"><?php _e( 'ID', APP_TD ); ?></th>
						...
						?>
							...
							<tr>
								...
								<td class="col2">
									<?php echo html( 'h3 class="tplCouponTitle"', html( 'a', array( 'href' => get_permalink( $listing_id ) ), get_the_title( $listing_id ) ) ); ?>
									<?php clpr_display_ordered_items( $order ); ?>
									<span class="clock"><span><?php the_time( get_option( 'date_format' ) ); ?></span></span>
								</td>
								<td class="col3 text-center"><?php appthemes_display_price( $order->get_total() ); ?></td>
